...
Framebuffer::Framebuffer(){
    ...
    std::string fboVertexShader = m_fboShader->LoadShader("./shaders/pixelatedVert.glsl");
    std::string fboFragmentShader = m_fboShader->LoadShader("./shaders/pixelatedFrag.glsl");
